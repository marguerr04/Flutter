    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.light(
          ...
          onSurface: AppColors.textoOscuro,   // Texto sobre superficies (ej. texto en cards)
          background: AppColors.fondoClaro,   // Fondo general de las pantallas
          onBackground: AppColors.textoOscuro,// Texto sobre el fondo general
        ...
        iconButtonTheme: IconButtonThemeData(
         ...
         dataTableTheme: DataTableThemeData(
            headingRowColor: MaterialStateProperty.all(Colors.grey[100]), // Fondo cabecera
